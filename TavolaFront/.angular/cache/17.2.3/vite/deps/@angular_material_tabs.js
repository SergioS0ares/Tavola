...
function MatTabGroup_For_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵclassMap(tab_r5.labelClass);
    ɵɵclassProp("mdc-tab--active", ctx_r1.selectedIndex === i_r6);
    ɵɵproperty("id", ctx_r1._getTabLabelId(i_r6))("disabled", tab_r5.disabled)("fitInkBarToContent", ctx_r1.fitInkBarToContent);
...
function MatTabGroup_For_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵclassMap(tab_r19.bodyClass);
    ɵɵclassProp("mat-mdc-tab-body-active", ctx_r4.selectedIndex === i_r20);
    ɵɵproperty("id", ctx_r4._getTabContentId(i_r20))("content", tab_r19.content)("position", tab_r19.position)("origin", tab_r19.origin)("animationDuration", ctx_r4.animationDuration)("preserveContent", ctx_r4.preserveContent);
...
_MatTabGroup.ɵcmp = ɵɵdefineComponent({
  ...
  template: function MatTabGroup_Template(rf, ctx) {
    if (rf & 1) {
      ...
      ɵɵrepeaterCreate(2, MatTabGroup_For_3_Template, 8, 17, "div", 12, ɵɵrepeaterTrackByIdentity);
      ɵɵelementEnd();
      ɵɵtemplate(4, MatTabGroup_Conditional_4_Template, 1, 0);
      ɵɵelementStart(5, "div", 2, 3);
      ɵɵrepeaterCreate(7, MatTabGroup_For_8_Template, 1, 13, "mat-tab-body", 13, ɵɵrepeaterTrackByIdentity);
      ɵɵelementEnd();
    }
    if (rf & 2) {
