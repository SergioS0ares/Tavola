...
_NgxMaskApplierService.ɵfac = function NgxMaskApplierService_Factory(t) {
  return new (t || _NgxMaskApplierService)();
};
...
_NgxMaskService.ɵfac = /* @__PURE__ */ (() => {
  ...
  return function NgxMaskService_Factory(t) {
    return (ɵNgxMaskService_BaseFactory || (ɵNgxMaskService_BaseFactory = ɵɵgetInheritedFactory(_NgxMaskService)))(t || _NgxMaskService);
  };
})();
...
_NgxMaskDirective.ɵfac = function NgxMaskDirective_Factory(t) {
  return new (t || _NgxMaskDirective)();
};
_NgxMaskDirective.ɵdir = ɵɵdefineDirective({
  ...
  inputs: {
    maskExpression: [InputFlags.None, "mask", "maskExpression"],
...
_NgxMaskPipe.ɵfac = function NgxMaskPipe_Factory(t) {
  return new (t || _NgxMaskPipe)();
};
