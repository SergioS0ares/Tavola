...
var InputMask = class _InputMask {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    inputs: {
      type: "type",
      slotChar: "slotChar",
      autoClear: [InputFlags.HasDecoratorInputTransform, "autoClear", "autoClear", booleanAttribute],
      ...
      unmask: [InputFlags.HasDecoratorInputTransform, "unmask", "unmask", booleanAttribute],
      name: "name",
      ...
      keepBuffer: [InputFlags.HasDecoratorInputTransform, "keepBuffer", "keepBuffer", booleanAttribute],
      mask: "mask"
    },
    outputs: {
